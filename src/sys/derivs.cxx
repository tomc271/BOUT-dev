...
SpatialDimensions::FieldMetric DDX(const Field2D& f, CELL_LOC outloc, const std::string& method,
                             const std::string& region) {
  return f.getCoordinates(outloc)->DDX(f, outloc, method, region);
}
...
SpatialDimensions::FieldMetric DDY(const Field2D& f, CELL_LOC outloc, const std::string& method,
                             const std::string& region) {
...
SpatialDimensions::FieldMetric DDZ(const Field2D& f, CELL_LOC UNUSED(outloc),
...
SpatialDimensions::FieldMetric D2DX2(const Field2D& f, CELL_LOC outloc,
...
SpatialDimensions::FieldMetric D2DY2(const Field2D& f, CELL_LOC outloc,
                               const std::string& method, const std::string& region) {
  Coordinates* coords = f.getCoordinates(outloc);
...
SpatialDimensions::FieldMetric D2DZ2(const Field2D& f, CELL_LOC outloc,
                               const std::string& method, const std::string& region) {
  return bout::derivatives::index::D2DZ2(f, outloc, method, region)
         / SQ(f.getCoordinates(outloc)->dz());
}
...
SpatialDimensions::FieldMetric D4DX4(const Field2D& f, CELL_LOC outloc,
                               const std::string& method, const std::string& region) {
  return bout::derivatives::index::D4DX4(f, outloc, method, region)
         / SQ(SQ(f.getCoordinates(outloc)->dx()));
}
...
SpatialDimensions::FieldMetric D4DY4(const Field2D& f, CELL_LOC outloc,
                               const std::string& method, const std::string& region) {
  return bout::derivatives::index::D4DY4(f, outloc, method, region)
         / SQ(SQ(f.getCoordinates(outloc)->dy()));
}
...
SpatialDimensions::FieldMetric D4DZ4(const Field2D& f, CELL_LOC outloc,
                               const std::string& method, const std::string& region) {
  return bout::derivatives::index::D4DZ4(f, outloc, method, region)
         / SQ(SQ(f.getCoordinates(outloc)->dz()));
}
 ...
 */
SpatialDimensions::FieldMetric D2DXDY(const Field2D& f, CELL_LOC outloc,
                                const std::string& method, const std::string& region,
...
SpatialDimensions::FieldMetric D2DXDZ(const Field2D& f, CELL_LOC outloc,
...
SpatialDimensions::FieldMetric D2DYDZ(const Field2D& f, CELL_LOC outloc,
                                [[maybe_unused]] const std::string& method,
                                [[maybe_unused]] const std::string& region) {
#if BOUT_USE_METRIC_3D
  Field3D tmp{f};
...
SpatialDimensions::FieldMetric VDDX(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
...
SpatialDimensions::FieldMetric VDDY(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
...
// special case where both are 2D
SpatialDimensions::FieldMetric VDDZ(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
...
SpatialDimensions::FieldMetric VDDZ([[maybe_unused]] const Field3D& v, const Field2D& f,
 ...
 *******************************************************************************/
SpatialDimensions::FieldMetric FDDX(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
...
SpatialDimensions::FieldMetric FDDY(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
...
SpatialDimensions::FieldMetric FDDZ(const Field2D& v, const Field2D& f, CELL_LOC outloc,
                              const std::string& method, const std::string& region) {
