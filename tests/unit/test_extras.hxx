...
public:
    FakeMeshFixture() {
        ...
        const auto dx = Field2D{1.0};
        const auto dy = Field2D{1.0};
        const auto dz = Field2D{1.0};
        const auto J = Field2D{1.0};
        const auto Bxy = Field2D{1.0};
        const auto g11 = Field2D{1.0};
        const auto g22 = Field2D{1.0};
        const auto g33 = Field2D{1.0};
        const auto g12 = Field2D{0.0};
        const auto g13 = Field2D{0.0};
        const auto g23 = Field2D{0.0};
        const auto g_11 = Field2D{1.0};
        const auto g_22 = Field2D{1.0};
        const auto g_33 = Field2D{1.0};
        const auto g_12 = Field2D{0.0};
        const auto g_13 = Field2D{0.0};
        const auto g_23 = Field2D{0.0};
        const auto ShiftTorsion = Field2D{0.0};
        const auto IntShiftTorsion = Field2D{0.0};
        test_coords = std::make_shared<Coordinates>(
                bout::globals::mesh, dx, dy, dz, J, Bxy,
        ...
        const auto dx_ = Field2D{1.0, mesh_staggered};
        const auto dy_ = Field2D{1.0, mesh_staggered};
        const auto dz_ = Field2D{1.0, mesh_staggered};
        const auto J_ = Field2D{1.0, mesh_staggered};
        const auto Bxy_ = Field2D{1.0, mesh_staggered};
        const auto g11_ = Field2D{1.0, mesh_staggered};
        const auto g22_ = Field2D{1.0, mesh_staggered};
        const auto g33_ = Field2D{1.0, mesh_staggered};
        const auto g12_ = Field2D{0.0, mesh_staggered};
        const auto g13_ = Field2D{0.0, mesh_staggered};
        const auto g23_ = Field2D{0.0, mesh_staggered};
        const auto g_11_ = Field2D{1.0, mesh_staggered};
        const auto g_22_ = Field2D{1.0, mesh_staggered};
        const auto g_33_ = Field2D{1.0, mesh_staggered};
        const auto g_12_ = Field2D{0.0, mesh_staggered};
        const auto g_13_ = Field2D{0.0, mesh_staggered};
        const auto g_23_ = Field2D{0.0, mesh_staggered};
        const auto ShiftTorsion_ = Field2D{0.0, mesh_staggered};
        const auto IntShiftTorsion_ = Field2D{0.0, mesh_staggered};
        test_coords_staggered = std::make_shared<Coordinates>(
                mesh_staggered, dx_, dy_, dz_, J_, Bxy,
                g11_, g22_, g33_, g12_, g13_, g23,
                g_11_, g_22_, g_33_, g_12_, g_13_, g_23,
                ShiftTorsion_, IntShiftTorsion_);
