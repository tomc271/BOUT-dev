 ...
 */
SpatialDimensions::FieldMetric Grad_par(const Field2D& var, CELL_LOC outloc = CELL_DEFAULT,
                                  const std::string& method = "DEFAULT");
inline SpatialDimensions::FieldMetric Grad_par(const Field2D& var, CELL_LOC outloc,
                                         DIFF_METHOD method) {
...
inline SpatialDimensions::FieldMetric Vpar_Grad_par(const Field2D& v, const Field2D& f,
 ...
 *
 */
SpatialDimensions::FieldMetric Div_par(const Field2D& f, CELL_LOC outloc = CELL_DEFAULT,
                                 const std::string& method = "DEFAULT");

inline SpatialDimensions::FieldMetric Div_par(const Field2D& f, CELL_LOC outloc,
                                        DIFF_METHOD method) {
 ...
 */
SpatialDimensions::FieldMetric Grad2_par2(const Field2D& f, CELL_LOC outloc = CELL_DEFAULT,
                                    const std::string& method = "DEFAULT");
inline SpatialDimensions::FieldMetric Grad2_par2(const Field2D& f, CELL_LOC outloc,
                                           DIFF_METHOD method) {
 ...
 */
SpatialDimensions::FieldMetric Delp2(const Field2D& f, CELL_LOC outloc = CELL_DEFAULT,
                               bool useFFT = true);
 ...
 *
 */
SpatialDimensions::FieldMetric Laplace_par(const Field2D& f, CELL_LOC outloc = CELL_DEFAULT);
Field3D Laplace_par(const Field3D& f, CELL_LOC outloc = CELL_DEFAULT);

/*!
 * Full Laplacian operator (par + perp)
 */
SpatialDimensions::FieldMetric Laplace(const Field2D& f, CELL_LOC outloc = CELL_DEFAULT,
                                 const std::string& dfdy_boundary_condition = "free_o3",
                                 const std::string& dfdy_region = "");
